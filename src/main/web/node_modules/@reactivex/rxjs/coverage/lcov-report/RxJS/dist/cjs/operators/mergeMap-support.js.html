...
<html lang="en">
<head>
    <title>Code coverage report for RxJS/dist/cjs/operators/mergeMap-support.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">RxJS/dist/cjs/operators/mergeMap-support.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">97.18% <small>(69 / 71)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">RxJS/dist/cjs/operators/</a> &#187; mergeMap-support.js</div>
</div>
<div class="body">
...
&nbsp;
    MergeMapSubscriber.prototype.notifyComplete = function notifyComplete(innerSub) {
        ...
        this.active--;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (buffer.length &gt; 0) {
...
&nbsp;
exports.MergeMapSubscriber = MergeMapSubscriber;</pre></td></tr>
</table></pre>
