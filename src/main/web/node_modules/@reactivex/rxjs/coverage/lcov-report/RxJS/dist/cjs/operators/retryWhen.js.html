...
<html lang="en">
<head>
    <title>Code coverage report for RxJS/dist/cjs/operators/retryWhen.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">RxJS/dist/cjs/operators/retryWhen.js</span></h1>
    <h2>
        Statements: <span class="metric">96.15% <small>(100 / 104)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">65.38% <small>(17 / 26)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">96.3% <small>(26 / 27)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">97.92% <small>(94 / 96)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">RxJS/dist/cjs/operators/</a> &#187; retryWhen.js</div>
</div>
<div class="body">
...
&nbsp;
    FirstRetryWhenSubscriber.prototype.error = function error(err) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.isUnsubscribed) {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.retryNotifications) {
                this.errors = new _Subject2['default']();
                var notifications = _utilTryCatch2['default'](this.notifier).call(this, this.errors);
                <span class="missing-if-branch" title="if path not taken" >I</span>if (notifications === _utilErrorObject.errorObject) {
<span class="cstat-no" title="statement not covered" >                    this.destination.error(_utilErrorObject.errorObject.e);</span>
                } else {
...
&nbsp;
    MoreRetryWhenSubscriber.prototype._complete = <span class="fstat-no" title="function not covered" >function _complete() {</span>
<span class="cstat-no" title="statement not covered" >        this.parent.destinationComplete();</span>
    };
&nbsp;
