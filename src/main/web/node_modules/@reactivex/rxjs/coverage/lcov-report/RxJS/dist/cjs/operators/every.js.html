...
<html lang="en">
<head>
    <title>Code coverage report for RxJS/dist/cjs/operators/every.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">RxJS/dist/cjs/operators/every.js</span></h1>
    <h2>
        Statements: <span class="metric">82.05% <small>(64 / 78)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">53.13% <small>(17 / 32)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">92.31% <small>(12 / 13)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">82.86% <small>(58 / 70)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">RxJS/dist/cjs/operators/</a> &#187; every.js</div>
</div>
<div class="body">
...
function every(predicate, thisArg) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (source._isScalar) {
<span class="cstat-no" title="statement not covered" >        result = _utilTryCatch2['default'](predicate)(source.value, 0, source);</span>
<span class="cstat-no" title="statement not covered" >        if (result === _utilErrorObject.errorObject) {</span>
<span class="cstat-no" title="statement not covered" >            return new _observablesErrorObservable2['default'](_utilErrorObject.errorObject.e, source.scheduler);</span>
        } else {
<span class="cstat-no" title="statement not covered" >            return new _observablesScalarObservable2['default'](result, source.scheduler);</span>
        }
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (source instanceof _observablesArrayObservable2['default']) {
<span class="cstat-no" title="statement not covered" >        var array = source.array;</span>
<span class="cstat-no" title="statement not covered" >        var _result = _utilTryCatch2['default'](<span class="fstat-no" title="function not covered" >function (array, predicate) {</span></span>
<span class="cstat-no" title="statement not covered" >            return array.every(predicate);</span>
        })(array, predicate);
<span class="cstat-no" title="statement not covered" >        if (_result === _utilErrorObject.errorObject) {</span>
<span class="cstat-no" title="statement not covered" >            return new _observablesErrorObservable2['default'](_utilErrorObject.errorObject.e, source.scheduler);</span>
        } else {
<span class="cstat-no" title="statement not covered" >            return new _observablesScalarObservable2['default'](_result, source.scheduler);</span>
        }
    }
