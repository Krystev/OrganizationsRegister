...
<html lang="en">
<head>
    <title>Code coverage report for RxJS/dist/cjs/operators/subscribeOn.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">RxJS/dist/cjs/operators/subscribeOn.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">RxJS/dist/cjs/operators/</a> &#187; subscribeOn.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function subscribeOn(scheduler) {</span>
<span class="cstat-no" title="statement not covered" >    var delay = arguments.length &lt;= 1 || arguments[1] === undefined ? 0 : arguments[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return new _observablesSubscribeOnObservable2['default'](this, delay, scheduler);</span>
}
&nbsp;
