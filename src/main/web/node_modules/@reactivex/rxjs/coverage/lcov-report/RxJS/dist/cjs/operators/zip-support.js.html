...
<html lang="en">
<head>
    <title>Code coverage report for RxJS/dist/cjs/operators/zip-support.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">RxJS/dist/cjs/operators/zip-support.js</span></h1>
    <h2>
        Statements: <span class="metric">95.65% <small>(154 / 161)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">78.57% <small>(44 / 56)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">RxJS/dist/cjs/operators/</a> &#187; zip-support.js</div>
</div>
<div class="body">
...
&nbsp;
    function ZipSubscriber(destination, project) {
        var values = arguments.length &lt;= 2 || <span class="branch-1 cbranch-no" title="branch not covered" >arguments[2] === undefined </span>? Object.create(null) : <span class="branch-1 cbranch-no" title="branch not covered" >arguments[2];</span>
&nbsp;
...
&nbsp;
    StaticArrayIterator.prototype[_utilSymbol_iterator2['default']] = <span class="fstat-no" title="function not covered" >function () {</span>
...
&nbsp;
    ZipBufferIterator.prototype[_utilSymbol_iterator2['default']] = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        return this;</span>
    };
&nbsp;
...
})(_OuterSubscriber3['default']);</pre></td></tr>
</table></pre>
