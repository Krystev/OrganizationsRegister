...
<html lang="en">
<head>
    <title>Code coverage report for RxJS/dist/cjs/operators/windowWhen.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">RxJS/dist/cjs/operators/windowWhen.js</span></h1>
    <h2>
        Statements: <span class="metric">89.61% <small>(69 / 77)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">RxJS/dist/cjs/operators/</a> &#187; windowWhen.js</div>
</div>
<div class="body">
...
&nbsp;
    WindowSubscriber.prototype._error = <span class="fstat-no" title="function not covered" >function _error(err) {</span>
<span class="cstat-no" title="statement not covered" >        this.window.error(err);</span>
...
&nbsp;
    WindowSubscriber.prototype.openWindow = function openWindow() {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (closingNotifier === _utilErrorObject.errorObject) {
<span class="cstat-no" title="statement not covered" >            var err = closingNotifier.e;</span>
<span class="cstat-no" title="statement not covered" >            this.destination.error(err);</span>
<span class="cstat-no" title="statement not covered" >            this.window.error(err);</span>
        } else {
...
&nbsp;
    WindowClosingNotifierSubscriber.prototype._error = <span class="fstat-no" title="function not covered" >function _error(err) {</span>
<span class="cstat-no" title="statement not covered" >        this.parent.error(err);</span>
    };
&nbsp;
    WindowClosingNotifierSubscriber.prototype._complete = <span class="fstat-no" title="function not covered" >function _complete() {</span>
        // noop
    };
&nbsp;
