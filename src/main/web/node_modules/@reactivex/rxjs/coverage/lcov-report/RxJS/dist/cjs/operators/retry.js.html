...
<html lang="en">
<head>
    <title>Code coverage report for RxJS/dist/cjs/operators/retry.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">RxJS/dist/cjs/operators/retry.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">RxJS/dist/cjs/operators/</a> &#187; retry.js</div>
</div>
<div class="body">
...
&nbsp;
    function RetryMoreSubscriber(parent, count) {
        var retried = arguments.length &lt;= 2 || arguments[2] === undefined ? <span class="branch-0 cbranch-no" title="branch not covered" >0 </span>: arguments[2];
&nbsp;
