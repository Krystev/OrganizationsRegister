...
<html lang="en">
<head>
    <title>Code coverage report for RxJS/dist/cjs/observables/ScalarObservable.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">RxJS/dist/cjs/observables/ScalarObservable.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">81.93% <small>(68 / 83)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">RxJS/dist/cjs/observables/</a> &#187; ScalarObservable.js</div>
</div>
<div class="body">
...
&nbsp;
    ScalarObservable.create = <span class="fstat-no" title="function not covered" >function create(value, scheduler) {</span>
<span class="cstat-no" title="statement not covered" >        return new ScalarObservable(value, scheduler);</span>
    };
&nbsp;
    ScalarObservable.dispatch = <span class="fstat-no" title="function not covered" >function dispatch(state) {</span>
<span class="cstat-no" title="statement not covered" >        var done = state.done;</span>
<span class="cstat-no" title="statement not covered" >        var value = state.value;</span>
<span class="cstat-no" title="statement not covered" >        var subscriber = state.subscriber;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        state.done = true;</span>
<span class="cstat-no" title="statement not covered" >        this.schedule(state);</span>
    };
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            subscriber.add(scheduler.schedule(ScalarObservable.dispatch, 0, {</span>
...
<span class="cstat-no" title="statement not covered" >        return new _ErrorObservable2['default'](_utilErrorObject.errorObject.e);</span>
    } else {
        return new ScalarObservable(result);
    }
};
proto.scan = <span class="fstat-no" title="function not covered" >function (project, acc) {</span>
<span class="cstat-no" title="statement not covered" >    return this.reduce(project, acc);</span>
};
