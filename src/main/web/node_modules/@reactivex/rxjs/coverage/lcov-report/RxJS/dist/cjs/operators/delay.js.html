...
<html lang="en">
<head>
    <title>Code coverage report for RxJS/dist/cjs/operators/delay.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">RxJS/dist/cjs/operators/delay.js</span></h1>
    <h2>
        Statements: <span class="metric">87.5% <small>(70 / 80)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">64.71% <small>(22 / 34)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">93.33% <small>(14 / 15)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">88.89% <small>(64 / 72)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">RxJS/dist/cjs/operators/</a> &#187; delay.js</div>
</div>
<div class="body">
...
&nbsp;
    DelaySubscriber.prototype._next = function _next(x) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.errored) {
<span class="cstat-no" title="statement not covered" >            return;</span>
        }
        var scheduler = this.scheduler;
        this.queue.push(new DelayMessage(scheduler.now() + this.delay, _Notification2['default'].createNext(x)));
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.active === false) {
            this._schedule(scheduler);
        }
    };
&nbsp;
    DelaySubscriber.prototype._error = <span class="fstat-no" title="function not covered" >function _error(e) {</span>
...
<span class="cstat-no" title="statement not covered" >        this.queue = [new DelayMessage(scheduler.now() + this.delay, _Notification2['default'].createError(e))];</span>
<span class="cstat-no" title="statement not covered" >        if (this.active === false) {</span>
<span class="cstat-no" title="statement not covered" >            this._schedule(scheduler);</span>
        }
    };
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            return;</span>
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.active === false) {
<span class="cstat-no" title="statement not covered" >            this._schedule(scheduler);</span>
        }
    };
&nbsp;
