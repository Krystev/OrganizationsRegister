...
<html lang="en">
<head>
    <title>Code coverage report for RxJS/dist/cjs/observables/IntervalObservable.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">RxJS/dist/cjs/observables/IntervalObservable.js</span></h1>
    <h2>
        Statements: <span class="metric">90.38% <small>(47 / 52)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">RxJS/dist/cjs/observables/</a> &#187; IntervalObservable.js</div>
</div>
<div class="body">
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!_utilIsNumeric2['default'](period) || period &lt; 0) {
<span class="cstat-no" title="statement not covered" >            this.period = 0;</span>
        }
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!scheduler || typeof scheduler.schedule !== 'function') {
<span class="cstat-no" title="statement not covered" >            this.scheduler = _schedulersNextTick2['default'];</span>
        }
    }
&nbsp;
